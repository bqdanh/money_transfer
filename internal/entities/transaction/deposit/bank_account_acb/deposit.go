...
func init() {
	deposit.RegisterDepositDataBuilder(
		...
		implement_bank_account.SourceOfFundCodeACB,
...
// DepositStatus represents the status of a deposit transaction at ACB bank.
...
func (d DepositData) GetSOFCode() account.SourceOfFundCode {
	return implement_bank_account.SourceOfFundCodeACB
}
