...
func init() {
	deposit.RegisterDepositDataBuilder(
		...
		implement_bank_account.SourceOfFundCodeVCB,
...
// DepositStatus represents the status of a deposit transaction at VCB bank.
...
func (d DepositData) GetSOFCode() account.SourceOfFundCode {
	return implement_bank_account.SourceOfFundCodeVCB
}
